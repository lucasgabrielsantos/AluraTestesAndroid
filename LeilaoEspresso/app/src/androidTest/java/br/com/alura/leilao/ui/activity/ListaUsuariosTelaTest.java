...
public class ListaUsuariosTelaTest {
    ...
    @Rule
    public ActivityTestRule<ListaLeilaoActivity> activityTestRule = new ActivityTestRule<>(ListaLeilaoActivity.class);
    ...
    public void listaUsuariosTelaTest() {
        ...
        ViewInteraction textInputEditText = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        textInputEditText.perform(replaceText("Lucas"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.item_usuario_id_com_nome), withText("(1) Lucas"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("(1) Lucas")));
    }
